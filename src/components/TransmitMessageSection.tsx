    ...
    <>
          ...
          >
            <div className="text-center space-y-4 px-8">
              <motion.div
                ...
                className="text-8xl font-black text-pink-glow"
                style={{ fontFamily: "var(--font-montserrat)", color: PINK }}
              >
                $
              </motion.div>
              ...
              <motion.div
                className="respect-text space-y-1 opacity-0"
                style={{ fontFamily: "var(--font-oswald)" }}
              >
                <div className="text-textMuted text-sm tracking-[0.3em] uppercase">Message Transmitted</div>
                <div className="text-sm tracking-[0.3em] font-bold uppercase text-pink-glow" style={{ color: PINK }}>
                  Respect +
                </div>
              </motion.div>
            </div>
      ...
      <div className="space-y-6">
        <div className="border-b border-[#282828] pb-4">
          ...
          <h2 className="gta-heading text-3xl text-textPrimary">VIP_CONTRACT</h2>
          <p className="text-textMuted text-[11px] tracking-widest mt-1"
            style={{ fontFamily: "var(--font-oswald)" }}>
            SUBMIT YOUR BRIEF — WE&apos;LL CLOSE THE DEAL
          </p>
        </div>

        <div className="gta-card p-6 relative overflow-hidden">
          {/* Pink left stripe */}
          <div className="absolute left-0 top-0 bottom-0 w-1" style={{ background: PINK }} />
          ...
          <div className="flex justify-between items-center mb-6 pl-4"
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] tracking-widest" style={{ color: PINK }}>ONLINE</span>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {isDone ? (
              <motion.div key="done" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                ...
                <div className="text-4xl font-black text-pink-glow"
                  style={{ fontFamily: "var(--font-montserrat)", color: PINK }}>
                  ✓ CONTRACT FILED
                </div>
                <p className="text-textMuted text-sm" style={{ fontFamily: "var(--font-oswald)" }}>
                  Transmission received. You&apos;ll hear back within 24 hours.
                </p>
                <button onClick={handleReset} onMouseEnter={playHover}
                  className="gta-btn-outline px-6 py-2.5 text-[11px] mt-4">
                  SEND ANOTHER
                </button>
              </motion.div>
            ) : isSubmitting ? (
              <motion.div key="transmitting" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                ...
                <div className="flex gap-1.5">
                  {[0,1,2,3,4].map((i) => (
                    <motion.div key={i} className="w-2 h-2" style={{ background: PINK }}
              ...
              <motion.form key="form" onSubmit={handleSubmit}
                ...
                <div className="space-y-2">
                  ...
                  <textarea id="brief" name="brief" rows={4} required
                    ...
                    placeholder="OUTLINE YOUR CONTRACT / TARGET BRIEF"
